...
if ( ! function_exists( 'vieclam24_setup_theme' ) ) {
	/**
	...
	add_action( 'after_setup_theme', 'vieclam24_setup_theme' );
...
if ( ! function_exists( 'vieclam24_add_user_fields' ) ) {
	...
	add_filter( 'user_contactmethods', 'vieclam24_add_user_fields' );
}
...
add_filter( 'comments_open', 'vieclam24_filter_media_comment_status', 10, 2 );
...
add_filter( 'edit_post_link', 'vieclam24_custom_edit_post_link' );
...
add_filter( 'edit_comment_link', 'vieclam24_custom_edit_comment_link' );
...
add_filter( 'embed_oembed_html', 'vieclam24_oembed_filter', 10 );

if ( ! function_exists( 'vieclam24_content_nav' ) ) {
	/**
...
add_action( 'widgets_init', 'vieclam24_widgets_init' );

if ( ! function_exists( 'vieclam24_article_posted_on' ) ) {
	/**
...
add_filter( 'the_password_form', 'vieclam24_password_form' );


if ( ! function_exists( 'vieclam24_comment' ) ) {
	/**
	 * Style Reply link.
	 *
	 * @since v1.0
	...
	add_filter( 'comment_reply_link', 'vieclam24_replace_reply_link_class' );
	...
	add_filter( 'comment_form_defaults', 'vieclam24_custom_commentform' );
}
...
add_action( 'wp_enqueue_scripts', 'vieclam24_scripts_loader' );
