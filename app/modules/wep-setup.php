...
class WEP_Setup {
    ...
    public function load_general_options() {
        ...
        if (!is_admin()) :
            ...
            global $general_options;
            $general_options = WEP_Helper::getJsonAsArray(THEME_APP . '/admin/option-json/general.json');

            // Lấy tùy chọn chung của hệ thống Menu
            global $menu_options;
            $menu_options = WEP_Helper::getJsonAsArray(THEME_APP . '/admin/option-json/menu.json');

            // Lấy tùy chọn chung của thành phần Widget Sidebar
            global $sidebar_options;
            $sidebar_options = WEP_Helper::getJsonAsArray(THEME_APP . '/admin/option-json/sidebar.json');

            // Lấy tùy chọn chung của thành phần Home
            global $home_options;
            $home_options = WEP_Helper::getJsonAsArray(THEME_APP . '/admin/option-json/home.json');
