 ...
 */
class WIB_Logo extends WIB_Base {
    private $model;
    private $view;
    private $shortcode = 'wib_logo'; /* <= name shorcode here */

    public function __construct($args = []) {
        $this->model = new WIB_Logo_Model($args);
        $this->view = new WIB_Logo_View($this->shortcode);
